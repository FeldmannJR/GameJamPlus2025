...
namespace FishNet.Discovery
{
    ...
    public sealed class NetworkDiscovery : MonoBehaviour
    {
        ...
        /// </summary>
        [SerializeField] [Tooltip("Secret to use when advertising or searching for servers.")]
        ...
        /// </summary>
        [SerializeField] [Tooltip("Port to use when advertising or searching for servers.")]
        private ushort port;
        ...
        public List<IPEndPoint> _foundServers = new();
                ...
                while (!cancellationToken.IsCancellationRequested)
                {
                    ...
                    if (completedTask == receiveTask)
                    {
                        ...
                        if (result.Buffer.Length == 1 && result.Buffer[0] == 1)
                        {
                            ...
                            _mainThreadSynchronizationContext.Post(_ =>
                            {
                                _foundServers.Add(result.RemoteEndPoint);
